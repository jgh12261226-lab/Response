...
function Text() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center relative shrink-0 w-full" data-name="Text">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[56px] text-center text-white tracking-[-1.4px] w-[min-content]">
...
function Background() {
  return (
    <div aria-hidden="true" className="h-[654px] relative shrink-0 w-full" data-name="Background" role="presentation">
      ...
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[96px] items-center pb-[96px] pt-[120px] px-[64px] relative size-full">
          <Text />
          <div className="aspect-[608/395] pointer-events-none relative rounded-[24px] shrink-0 w-full" data-name="Device frame">
            <img alt="Product detail" className="absolute inset-0 max-w-none object-cover rounded-[24px] size-full" src={imgDeviceFrame} />
...
function Content() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start pb-[64px] relative shrink-0 w-full" data-name="Content">
      <Text1 />
      <Button />
    </div>
  );
  ...
  return (
    <section className="relative shrink-0 w-full" data-name="Testimonial">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[32px] items-center justify-center pb-[80px] pt-[64px] px-[64px] relative w-full">
          <Header />
          <Cards />
        </div>
      </div>
...
function Column2() {
  return (
    <nav className="content-stretch flex flex-col gap-[8px] items-start justify-center relative shrink-0 w-[90px]" data-name="Column 1">
      <Header3 />
...
function Column5() {
  return (
    <nav className="content-stretch flex flex-col gap-[8px] items-start justify-center relative shrink-0 w-[90px]" data-name="Column 4">
      <Header6 />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-[rgba(255,255,255,0.6)] tracking-[-0.08px] w-full">
  ...
  return (
    <div aria-hidden="true" className="relative shrink-0 w-full" data-name="Image" role="presentation">
      ...
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center pb-[96px] px-[64px] relative w-full">
          <Content1 />
        </div>
      </div>
    </div>
...
export default function Tablet() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center relative size-full" data-name="Tablet">
      <Container />
    </div>
  );
}