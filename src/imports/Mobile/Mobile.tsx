...
function PrimaryButton() {
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full" data-name="Primary button">
...
function SecondaryButton() {
  return (
    <div className="relative rounded-[12px] shrink-0 w-full" data-name="Secondary button">
...
function Buttons() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-end relative shrink-0 w-full" data-name="Buttons">
      <PrimaryButton />
      <SecondaryButton />
    </div>
  );
...
function Text() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-center relative shrink-0 w-full" data-name="Text">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[44px] text-center text-white tracking-[-1.1px] w-full">
...
function Background() {
  return (
    <div aria-hidden="true" className="h-[528px] relative shrink-0 w-full" data-name="Background" role="presentation">
      ...
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[64px] items-center pb-[64px] pt-[96px] px-[24px] relative size-full">
          <Text />
          <div className="aspect-[922/599] pointer-events-none relative rounded-[16px] shrink-0 w-full" data-name="Device frame">
            <img alt="Product detail" className="absolute inset-0 max-w-none object-cover rounded-[16px] size-full" src={imgDeviceFrame} />
...
function Content() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start pb-[48px] relative shrink-0 w-full" data-name="Content">
      <Text1 />
      <Button />
    </div>
  );
...
function FeatureGallery() {
  return (
    <section className="relative shrink-0 w-full" data-name="Feature gallery">
      <div className="content-stretch flex flex-col items-start pb-[40px] pt-[64px] px-[24px] relative w-full">
        <ImageAndText />
      </div>
    </section>
  );
...
function Card() {
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Card 1">
...
function Cards() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full" data-name="Cards">
      <Card />
      <Card1 />
    </div>
  );
  ...
  return (
    <section className="relative shrink-0 w-full" data-name="Testimonial">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[32px] items-center justify-center pb-[64px] pt-[40px] px-[24px] relative w-full">
          <Header />
          <Cards />
        </div>
      </div>
...
function Nav() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0" data-name="Nav">
      <Column2 />
      <Column3 />
      <Column4 />
      <Column5 />
...
function Content1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[32px] items-start min-h-px min-w-px py-[64px] relative" data-name="Content">
...
export default function Mobile() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center relative size-full" data-name="Mobile">
      <Container />
    </div>
  );
}